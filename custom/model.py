    ...
    if is_training:
        if step > pc.step_3:
            ...
            if pc.enable_STEES:
                ...
                STE_mask = STE_binary_with_ratio.apply(entropy_mask_hat, pc.es_ratio)
                entropy_mask = None
            else:
                STE_mask = None
                entropy_mask = None
            ...
            bit_feat = entropy_skipping(feat_chosen, mean, scale, Q_feat, pc._anchor_feat.mean(), pc.es_ratio, entropy_mask, STE_mask, inplace=True)
